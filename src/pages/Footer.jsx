    ...
    Contact Us
      ...
      <div className="max-w-7xl mx-auto mt-8 pt-8 border-t border-gray-700 flex flex-col sm:flex-col ">
        ...
        <div className="flex space-x-4">
          ...
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/company/kiit-e-cell/" className="flex  justify-center w-8 h-8 sm:text-left py-4">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/ecell_kiit?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="flex  justify-center w-8 h-8 sm:text-left py-4">
          ...
          {/* YouTube */}
          <a href="https://www.youtube.com/@KIIT-ECELL" className="flex justify-center w-8 h-8 sm:text-left py-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Facebook */}
          <a href="https://www.facebook.com/kiitecell/" className="flex justify-center w-8 h-8 sm:text-left py-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white" fill="currentColor" viewBox="0 0 24 24">
